...
%%
SNR = 5 ;   sigma_t = 10^(SNR/10);
SNRstart = 0;  SNRinterval = 10  ; SNRpoint = 15;
for ii = 1 : SNRpoint
    ii
    L = SNRstart + ii* SNRinterval;  %%%% training data size
    %%%%%%%%%%%%%%%%%%%  threshold  %%%%%%%%%%%%%%%%%
    latter_num = 100;
...
grid on;
xlabel('Training Data Size \it L'); ylabel('Probability of Detection');
legend('Proposed, SNR = 5','Known pattern, SNR = 5', 'Proposed, SNR = 10','Known pattern, SNR = 10')
